...
# echo line of 'textfile1' and 'textfile2' has following format
# 
def similarityScoreCal(textfile1, textfile2, outputFilePath, sim_cal_method_id):
	...
	with open(os.path.join(textfile2),"rt") as targetFile:
		for line in targetFile:
			...
			score=round(score, 4)
			outputFile.write(parts[0].strip()+":"+str(score)+"\n")
...
def main(argv):
	...
	if len(argv) != 7:
		print("\n==============================================================================================================")
		print("\nUsage: python <this_script> AEType dsType detectorsTag recogFilePath1 recogFilePath2 resultDir sim_cal_id")
		print("\n==============================================================================================================")
		return


	AEType = argv[0].strip() # AE or Benign
	dsType = argv[1].strip() # Train or Test 
	...
	outputFileName=sim_cal_id+"_"+AEType+"_"+dsType+"_"+detectorsTag+".txt"
